class GroupRevenue extends React.Component {
  ...
  getGameCharts() {
    if (this.state.games.length > 0) {
      return React.createElement("div", null, React.createElement(BucketedSalesChart, {
        ...
        legend: true,
        name: "Sales by game"
      }), React.createElement(BucketedSalesChart, {
    ...
    setInterval(function () {
      ...
      if (groupRevenueSummaryTab.length > 0) {
        ...
        if (rplusRevenueContainer.length <= 0) {
          ...
          ReactDOM.render(React.createElement(GroupRevenue, {
            groupId: groupId
