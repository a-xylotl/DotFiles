class FeaturedCatalogItems extends React.Component {
  ...
  render() {
    ...
    }, React.createElement("h3", null, "Sponsored by Roblox+")), React.createElement("div", null, React.createElement("ul", {
...
RPlus.settings.get().then(function (settings) {
  ...
  ReactDOM.render(React.createElement(FeaturedCatalogItems, null), container[0]);
