class BucketedSalesChart extends React.Component {
  ...
  loadStatusSuccess(status) {
    if (status) {
      ...
      this.setState({
        loadStatus: React.createElement("span", {
  ...
  render() {
    return React.createElement("div", null, React.createElement("h3", null, this.props.name), React.createElement("div", {
    ...
    }, "Hourly"), React.createElement("option", {
