class ItemDetailsTabs extends React.Component {
  ...
  getTabsHeader() {
    if (this.state.tabs.length === 1) {
      ...
      }, React.createElement("h3", null, this.getTabTitle(this.state.tabs[0])));
    }
    ...
    return this.props.tabTypes.map(tabType => {
      switch (tabType) {
        case ItemDetailsTabs.tabTypes.owners:
          ...
          }, React.createElement(ItemOwners, {
        ...
        case ItemDetailsTabs.tabTypes.linkedItems:
          return React.createElement("div", {
            class: this.getTabPaneClassName(tabType)
          }, React.createElement(LinkedItems, {
  ...
  render() {
    ...
    return React.createElement("div", {
      class: "rplus-item-details-tabs"
    }, this.getTabsHeader(), React.createElement("div", {
      class: "tab-content"
    }, this.getTabContent()));
  }
