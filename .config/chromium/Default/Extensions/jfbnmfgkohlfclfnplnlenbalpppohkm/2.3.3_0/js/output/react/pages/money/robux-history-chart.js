class RobuxHistoryChart extends React.Component {
  ...
  render() {
    return React.createElement("div", null, React.createElement("h3", null, this.state.chartName), React.createElement("div", {
...
RPlus.robuxHistory.isEnabled().then(robuxHistoryEnabled => {
  ...
  let summaryTab = $("#Summary_tab").append(robuxHistoryContainer); // This.... is a sin.......
  ...
  let robuxHistoryChart = ReactDOM.render(React.createElement(RobuxHistoryChart, {
